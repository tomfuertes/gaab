...
(function (window, libName) {
  ...
  window[libName] = function (name, dimension, experiments) {
    return function (tracker) {

      var clientId = tracker.get('clientId'); // https://developers.google.com/analytics/devguides/collection/analyticsjs/domains#getClientId
